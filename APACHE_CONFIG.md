...
- **config/.htaccess**: Deny all access to configuration files
- **src/.htaccess**: Deny all access to source code
- **vendor/.htaccess**: Deny all access to vendor files
- **themes/.htaccess**: Deny all access to theme source files
